using Tyuiu.PashkovGV.Sprint0.Task6.V0.Lib;
namespace Tyuiu.PashkovGV.Sprint0.Task6.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Сумма элеиентов массива = " + DataService.AdditionArray(arraynums));
